...
const offerings = [
  ...
  },
  {
    ...
    timeline: "Late 2026",
    description: "You join Gruyters Ventures LLC as a W-2 employee — your OPT employer of record — while building your own company. Your IP stays yours.",
    features: ["W-2 OPT employer of record", "IP remains 100% yours", "Gruyters Ventures umbrella", "Optional equity arrangement"],
    ...
    <>
      ...
      <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 pt-20 pb-24 md:pt-28 md:pb-32">
        ...
        <div className="mx-auto max-w-4xl text-center relative">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-black tracking-tight leading-[1.05] mb-5">
            <span className="text-[#F8FAFC]">Don&apos;t lose</span>{" "}
            <span className="text-gradient">your status.</span>
          </h1>

          <p className="text-xl sm:text-2xl text-[#94A3B8] font-medium max-w-2xl mx-auto mb-3 leading-snug">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
            <Link
              href="/timeline"
              className="px-7 py-3.5 rounded-xl bg-[#22C55E] text-[#080D1A] font-bold text-base hover:bg-[#4ADE80] transition-colors shadow-lg shadow-[#22C55E]/20"
            >
              See your OPT timeline →
            </Link>
            <Link
              href="/#waitlist"
              className="px-6 py-3.5 rounded-xl border border-white/[0.12] text-[#94A3B8] font-medium text-base hover:text-white hover:border-white/20 transition-colors"
            >
          ...
          <p className="text-xs text-[#475569]">
            <span className="opt-brand text-[#64748B]">
          ...
          {stats.map(({ value, label, sub, href }) => (
            <div key={label} className="text-center">
              ...
              <a
                ...
                className="text-xs text-[#475569] hover:text-[#22C55E] transition-colors underline underline-offset-2"
              >
                {sub} ↗
              </a>
            </div>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
            ...
            <div className="flex-shrink-0">
              <div className="w-24 h-24 rounded-2xl border-2 border-dashed border-[#22C55E]/30 bg-[#0F1729] flex items-center justify-center text-2xl">
                📸
              </div>
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#22C55E] mb-2">Built by an insider</p>
              <h2 className="text-2xl md:text-3xl font-bold text-[#F8FAFC] mb-3 leading-tight">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-white/[0.10] text-[#94A3B8] text-sm hover:text-white hover:border-white/20 transition-colors"
                >
                  <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                  Guillaume on LinkedIn
                </a>
                <span className="text-xs text-[#475569]">Kellogg MBA &apos;26 · On OPT · Chicago, IL</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="opt-tool" className="px-4 sm:px-6 lg:px-8 py-20 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          <div className="rounded-2xl border border-[#22C55E]/20 bg-[#22C55E]/5 p-10 md:p-14">
            <p className="text-xs font-semibold uppercase tracking-widest text-[#22C55E] mb-3">Free — No signup required</p>
            ...
            <p className="text-[#94A3B8] text-base max-w-xl mx-auto mb-3">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div className="text-left">
              <p className="text-sm font-semibold text-[#F8FAFC]">Guillaume</p>
              <p className="text-xs text-[#64748B]">Belgian-Swiss founder · Kellogg MBA &apos;26 · Filed I-765 June 2026</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="waitlist" className="px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#22C55E] mb-3">Join 1,000+ F-1 students</p>
          ...
          <p className="text-xs text-[#475569] mt-3">
            ...
            <Link href="/privacy" className="underline hover:text-[#94A3B8] transition-colors">
              privacy policy
            </Link>
            .
          </p>
